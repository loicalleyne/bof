...
description: >
  ...
  proposing fixes. Triggers on: "test is failing", "this bug", "unexpected
  behavior", "why is this broken", "debug this".
---
...
4. **Gather Evidence in Multi-Component Systems**
   ...
   **WHEN system has multiple components (e.g., API → service → database):**
...
Watch for these redirections from the developer:
